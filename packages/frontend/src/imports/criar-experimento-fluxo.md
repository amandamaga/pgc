**Prompt para Figma AI — Fluxo “Criar Experimento” (MVP do TCC)**
...
## Telas geradas neste fluxo

1. Criar experimento — Informações gerais
2. Criar experimento — Configurar sessões
3. Confirmação de criação do experimento
